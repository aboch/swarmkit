...
type Cluster struct {
	...
	// RoutingMeshDisabled indicates whether the routing mesh is currently
	// disabled. By default the routing mesh is enabled. As result of user
	// removing the ingress network, this flag will be set to true. Cluster
	// needs to carry this information, so that on reboot or on leader re-
	// election, new leader will not automatically create the routing mesh if
	// it cannot find one in store.
	RoutingMeshDisabled bool `protobuf:"varint,10,opt,name=routing_mesh_disabled,json=routingMeshDisabled,proto3" json:"routing_mesh_disabled,omitempty"`
}
...
func (this *Cluster) String() string {
	...
	s := strings.Join([]string{`&Cluster{`,
		...
		`RoutingMeshDisabled:` + fmt.Sprintf("%v", this.RoutingMeshDisabled) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Cluster) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RoutingMeshDisabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RoutingMeshDisabled = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipObjects(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorObjects = []byte{
	...
	,
}
