...
// ExecutorAttachment specifies the allocation state
// for the connection of a container to a network.
type ExecutorAttachment struct {
	ID   string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta Meta   `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	// NodeID specifies the node where the attachment is taking place.
	NodeID     string                 `protobuf:"bytes,3,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	Spec       ExecutorAttachmentSpec `protobuf:"bytes,4,opt,name=spec" json:"spec"`
	Attachment *NetworkAttachment     `protobuf:"bytes,5,opt,name=attachment" json:"attachment,omitempty"`
	Status     AttachmentStatus       `protobuf:"bytes,6,opt,name=status" json:"status"`
}

func (m *ExecutorAttachment) Reset()                    { *m = ExecutorAttachment{} }
func (*ExecutorAttachment) ProtoMessage()               {}
func (*ExecutorAttachment) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{8} }
...
func init() {
	...
	proto.RegisterType((*ExecutorAttachment)(nil), "docker.swarmkit.v1.ExecutorAttachment")
}
...
func (m *ExecutorAttachment) Copy() *ExecutorAttachment {
	if m == nil {
		return nil
	}

	o := &ExecutorAttachment{
		ID:         m.ID,
		Meta:       *m.Meta.Copy(),
		NodeID:     m.NodeID,
		Spec:       *m.Spec.Copy(),
...
func (this *ExecutorAttachment) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&api.ExecutorAttachment{")
	s = append(s, "ID: "+fmt.Sprintf("%#v", this.ID)+",\n")
	s = append(s, "Meta: "+strings.Replace(this.Meta.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "NodeID: "+fmt.Sprintf("%#v", this.NodeID)+",\n")
	s = append(s, "Spec: "+strings.Replace(this.Spec.GoString(), `&`, ``, 1)+",\n")
...
func (m *ExecutorAttachment) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ExecutorAttachment) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Attachment != nil {
		...
		i++
		i = encodeVarintObjects(data, i, uint64(m.Attachment.Size()))
		n32, err := m.Attachment.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *ExecutorAttachment) Size() (n int) {
	var l int
	_ = l
	l = len(m.ID)
	if l > 0 {
...
func (this *ExecutorAttachment) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ExecutorAttachment{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`NodeID:` + fmt.Sprintf("%v", this.NodeID) + `,`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "ExecutorAttachmentSpec", "ExecutorAttachmentSpec", 1), `&`, ``, 1) + `,`,
		`Attachment:` + strings.Replace(fmt.Sprintf("%v", this.Attachment), "NetworkAttachment", "NetworkAttachment", 1) + `,`,
...
func (m *ExecutorAttachment) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExecutorAttachment: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExecutorAttachment: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorObjects = []byte{
	...
	,
}
