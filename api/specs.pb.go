...
// ExecutorAttachmentSpec specifies the allocation information
// for the executor attachment.
type ExecutorAttachmentSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// NodeID specifies the node on which the attachment is to be placed
	NodeID string `protobuf:"bytes,2,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	// Target specifies the network to attach to.
	Target string `protobuf:"bytes,3,opt,name=target,proto3" json:"target,omitempty"`
	// Addresses are the IPv4/IPv6 addresses specified for this attachment.
	Addresses []string `protobuf:"bytes,4,rep,name=addresses" json:"addresses,omitempty"`
}

func (m *ExecutorAttachmentSpec) Reset()                    { *m = ExecutorAttachmentSpec{} }
func (*ExecutorAttachmentSpec) ProtoMessage()               {}
func (*ExecutorAttachmentSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{9} }
...
func init() {
	...
	proto.RegisterType((*ExecutorAttachmentSpec)(nil), "docker.swarmkit.v1.ExecutorAttachmentSpec")
...
func (m *ExecutorAttachmentSpec) Copy() *ExecutorAttachmentSpec {
	if m == nil {
		return nil
	}

	o := &ExecutorAttachmentSpec{
		Annotations: *m.Annotations.Copy(),
		NodeID:      m.NodeID,
		Target:      m.Target,
	}
...
func (this *ExecutorAttachmentSpec) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&api.ExecutorAttachmentSpec{")
	s = append(s, "Annotations: "+strings.Replace(this.Annotations.GoString(), `&`, ``, 1)+",\n")
...
func (m *ExecutorAttachmentSpec) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ExecutorAttachmentSpec) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.NodeID) > 0 {
		data[i] = 0x12
		i++
		i = encodeVarintSpecs(data, i, uint64(len(m.NodeID)))
...
func (m *ExecutorAttachmentSpec) Size() (n int) {
	var l int
	_ = l
	l = m.Annotations.Size()
	n += 1 + l + sovSpecs(uint64(l))
...
func (this *ExecutorAttachmentSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ExecutorAttachmentSpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
...
func (m *ExecutorAttachmentSpec) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExecutorAttachmentSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExecutorAttachmentSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorSpecs = []byte{
	...
	,
}
