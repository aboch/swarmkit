...
type StoreAction_Attachment struct {
	Attachment *ExecutorAttachment `protobuf:"bytes,7,opt,name=attachment,oneof"`
}
...
func (*StoreAction_Attachment) isStoreAction_Target() {}
...
func (m *StoreAction) GetAttachment() *ExecutorAttachment {
	if x, ok := m.GetTarget().(*StoreAction_Attachment); ok {
		return x.Attachment
	}
	return nil
}
...
func _StoreAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // target.cluster
		...
		return true, err
	case 7: // target.attachment
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ExecutorAttachment)
		err := b.DecodeMessage(msg)
		m.Target = &StoreAction_Attachment{msg}
		return true, err
	default:
		return false, nil
	}
...
func (this *StoreAction_Attachment) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&api.StoreAction_Attachment{` +
...
func (m *StoreAction_Attachment) MarshalTo(data []byte) (int, error) {
	i := 0
	if m.Attachment != nil {
		data[i] = 0x3a
		i++
		i = encodeVarintRaft(data, i, uint64(m.Attachment.Size()))
...
func (m *StoreAction_Attachment) Size() (n int) {
	var l int
	_ = l
	if m.Attachment != nil {
		l = m.Attachment.Size()
...
func (this *StoreAction_Attachment) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreAction_Attachment{`,
		`Attachment:` + strings.Replace(fmt.Sprintf("%v", this.Attachment), "ExecutorAttachment", "ExecutorAttachment", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *StoreAction) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			v := &ExecutorAttachment{}
			if err := v.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Target = &StoreAction_Attachment{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaft(data[iNdEx:])
...
var fileDescriptorRaft = []byte{
	...
	,
}
